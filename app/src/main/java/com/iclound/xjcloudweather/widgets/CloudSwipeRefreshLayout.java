...
public class CloudSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private static final String LOG_TAG = CloudSwipeRefreshLayout.class.getSimpleName();
    ...
    private static final int DEFAULT_CIRCLE_TARGET = 76; //xjcloud modify
    ...
    //xjcloud modify
    CloudCircleImageView mCircleView;
    ...
    SunLoadingDrawable mProgress; //xjcloud modify
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link CloudSwipeRefreshLayout#onSaveInstanceState()}
         */
     ...
     * @param context
     */
    public CloudSwipeRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public CloudSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        mCircleView = new CloudCircleImageView(getContext());
        mCircleView.setBackgroundColor(Color.TRANSPARENT);
        mProgress = new SunLoadingDrawable(getResources().getDrawable(R.drawable.icon_sun_loading, null), getResources().getDrawable(R.drawable.icon_cloud_loading, null));
    ...
    /**
     * Set a callback to override {@link CloudSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        //xjcloud modify
       // System.out.println("SwipeRefresh"+  " targetY:" + targetY);
        if(targetY >= 0){
            ((ViewGroup)mTarget).getChildAt(0).scrollTo(0, -targetY);
        }
    ...
    private void finishSpinner(float overscrollTop) {
        ...
        if (overscrollTop > mTotalDragDistance) {
            ...
            // cancel refresh
            mRefreshing = false;
            //mProgress.setStartEndTrim(0f, 0f); //xjcloud modify
            ...
            //mProgress.setArrowEnabled(false);//xjcloud modify
        }
    }
    ...
    /**
     * Classes that wish to override {@link CloudSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link CloudSwipeRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull CloudSwipeRefreshLayout parent, @Nullable View child);
    }
}
